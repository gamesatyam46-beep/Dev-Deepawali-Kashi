...
export const StorySection: React.FC = () => {
  return (
    <section id="story" className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-[#0a0e17] relative overflow-hidden border-t border-[#d4af37]/20">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-5 sm:space-y-6">
            ...
            <h2 className="font-serif text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-[#f2ca50] leading-tight">
              WHEN KASHI LIGHTS UP
            </h2>

            <div className="p-4 rounded-xl bg-[#101624]/90 border border-[#d4af37]/40 border-l-4 border-l-[#f2ca50]">
              <p className="font-serif text-sm sm:text-base md:text-lg text-[#ffe088] leading-relaxed">
            ...
            <div className="space-y-3.5 text-xs sm:text-sm md:text-base text-[#d0c5af] leading-relaxed">
              <p>
            ...
            {/* Key Cultural Pillars: Stack vertically on mobile (<768px), 3-col on tablet/desktop */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5 sm:gap-4 pt-2">
              <div className="p-4 rounded-xl bg-[#101624] border border-[#d4af37]/25 hover:border-[#d4af37]/50 transition-colors shadow-lg">
                ...
                <p className="text-xs text-[#8e9cb4] mt-1 leading-relaxed">Celebrating Mahadeva's victory over darkness and ego.</p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-[#101624] border border-[#d4af37]/25 hover:border-[#d4af37]/50 transition-colors shadow-lg">
                ...
                <p className="text-xs text-[#8e9cb4] mt-1 leading-relaxed">Centuries of royal heritage, temples, and stone architecture.</p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-[#101624] border border-[#d4af37]/25 hover:border-[#d4af37]/50 transition-colors shadow-lg">
                ...
                <p className="text-xs text-[#8e9cb4] mt-1 leading-relaxed">A golden river of light reflecting upon the holy Ganges.</p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5">
            <div className="relative rounded-2xl overflow-hidden border border-[#d4af37]/40 shadow-[0_0_40px_rgba(212,175,55,0.25)] group">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 bg-gradient-to-t from-[#0a0e17] via-[#0a0e17]/95 to-transparent">
                <div className="font-serif text-xs sm:text-base text-[#ffe088] italic mb-1 leading-relaxed">
                  "बनारस सिर्फ एक शहर नहीं, एक अनुभव है... और देव दीपावली उस अनुभव की चरम सीमा है।"
                </div>
                <div className="text-[11px] sm:text-xs text-[#d0c5af]">
